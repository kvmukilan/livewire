...
Livewire v0.6.0 is a protocol-adaptive PCAP replay platform for reproducing
...
- [What v0.6.0 adds](#what-v060-adds)
...
offline. Live replay from the dashboard needs the same privileges as the CLI.
