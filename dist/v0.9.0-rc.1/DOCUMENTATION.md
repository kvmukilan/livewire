# Livewire v0.9.0-rc.1 Operator Guide
...
```powershell
Copy-Item .\dist\v0.9.0-rc.1\livewire-0.9.0-rc.1-windows-amd64.exe .\bin\livewire.exe
```
...
```bash
install -m 0755 ./dist/v0.9.0-rc.1/livewire-0.9.0-rc.1-linux-amd64 ./bin/livewire
```
...
## 16. Deliberate v0.9.0-rc.1 boundaries
...
./scripts/release.ps1 -Version 0.9.0-rc.1
```
